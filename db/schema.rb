...
ActiveRecord::Schema.define(:version => 20111202001001) do
  ...
  create_table "corevalue_scores", :force => true do |t|
    ...
    t.integer   "teamwork"
    t.integer   "grac_prof"
    t.string    "award_inspiration"
    t.string    "award_teamwork"
    t.string    "award_gracprof"
  end
  ...
  create_table "project_scores", :force => true do |t|
    ...
    t.string    "award_research"
    t.string    "award_innosolution"
    t.string    "award_presentation"
  end
  ...
  create_table "robot_scores", :force => true do |t|
    ...
    t.string    "award_mechdesign"
    t.string    "award_programming"
    t.string    "award_strategy"
  end
