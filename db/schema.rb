...
ActiveRecord::Schema.define(version: 20160910030538) do
  ...
  create_table "corevalue_scores", force: :cascade do |t|
  ...
  add_index "project_scores", ["team_id"], name: "index_project_scores_on_team_id", using: :btree

  create_table "robot_scores", force: :cascade do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "team_id"
    t.integer  "total_score"
  ...
  add_index "robot_scores", ["team_id"], name: "index_robot_scores_on_team_id", using: :btree
