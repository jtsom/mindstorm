module Api
	class TeamsController < ApplicationController
		...
		def index
			...
			respond_with teams.to_json(only: [:fll_number, :team_name, :coach, :town, :id], include: [qualifications: {}])
		end
		...
		def show
			...
			respond_with team.to_json(only: [:fll_number, :team_name, :coach, :town, :id], include: [qualifications: {}])
		end
